...
public class RemoveWhiteListReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        if (!AutomationSecurity.isAuthorizedAutomationIntent(
            ...
            log("Rejected unauthorized " + Utils.ACTION_REMOVE_WHITELIST + " broadcast");
            return;
        }
        ...
        log(Utils.ACTION_REMOVE_WHITELIST
        ...
        AsyncTask.execute(new Runnable() {
            ...
            public void run() {
                ...
                if (output != null) {
                    ...
                    log("Error occurred while removing validated package from DeviceIdle whitelist");
                }
            }
        });
    }
